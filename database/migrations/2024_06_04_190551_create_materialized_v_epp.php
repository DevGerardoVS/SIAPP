...
return new class extends Migration
{
    ...
    public function up()
    {
        // Renombrar la vista v_epp a v2_epp
        DB::statement('RENAME TABLE v_epp TO v2_epp');
           // Crear la tabla materializada v_epp
           DB::statement("
           CREATE TABLE v_epp AS
           SELECT 
               e.id,
    ...
    public function down()
    {
        ...
        // Renombrar la vista v2_epp a v_epp
        DB::statement('RENAME TABLE v2_epp TO v_epp');
    }
};

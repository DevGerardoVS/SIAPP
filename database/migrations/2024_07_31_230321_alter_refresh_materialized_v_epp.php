...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::unprepared("CREATE PROCEDURE refresh_materialized_v_epp()
begin
	...
	insert into v_epp(
		...
		clv_tipologia_conac,tipologia_conac,clv_programa,programa,clv_subprograma,subprograma,clv_proyecto,proyecto,estatus,presupuestable,con_mir,confirmado,tipo_presupuesto,created_at,updated_at,deleted_at,created_user,updated_user,deleted_user
	)
	select 

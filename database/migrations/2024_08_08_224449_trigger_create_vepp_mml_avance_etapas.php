...
return new class extends Migration
{
    ...
    {
        DB::unprepared('
            CREATE TRIGGER update_mmlAvaEtaPP_on_softdelete
            AFTER INSERT ON v_epp
            FOR EACH ROW
            BEGIN
    ...
    {
        DB::unprepared('DROP TRIGGER IF EXISTS update_mmlAvaEtaPP_on_softdelete');
    }
};
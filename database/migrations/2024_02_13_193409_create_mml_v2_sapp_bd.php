...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        try {
            ...
            if (!Schema::hasColumn('permisos_funciones', 'created_user') && !Schema::hasColumn('permisos_funciones', 'updated_user') && !Schema::hasColumn('permisos_funciones', 'deleted_user')) {
            ...
            if (!Schema::hasColumn('cat_permisos', 'id_sistema')) {
            ...
            if (!Schema::hasColumn('notificaciones', 'payload') && !Schema::hasColumn('notificaciones', 'status')) {

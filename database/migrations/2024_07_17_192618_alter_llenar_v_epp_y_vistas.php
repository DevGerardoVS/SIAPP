...
select 
	...
	c1.clave clv_fondo_federal,c1.descripcion fondo_federal,
	c4.clave clv_fondo_ramo,c4.descripcion fondo_ramo,
	c2.clave clv_programa,c2.descripcion programa,
	r33.ejercicio
from ramo_33 r33
join fondo f on f.id = r33.ramo_fondo_id
join catalogo c1 on r33.fondo_federal_id = c1.id
join catalogo c2 on r33.programa_id = c2.id
...
select 
	...
	c4.clave clv_partida_especifica,c4.descripcion partida_especifica,c4.descripcion_corta partida_especifica_desc_corta,
	...
	concat(
		c1.clave,c2.clave,c3.clave,c4.clave,c5.clave
	) posicion_presupuestaria_llave

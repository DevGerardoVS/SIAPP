    ...
    <div class="mx-auto p-4" style="width:90%;">
        ...
        @endif
            ...
            <div class="d-flex flex-wrap justify-content-end mb-5 mt-sm-2 mt-lg-0">
                ...
                <button id="btnExcel" type="submit" formtarget="_blank" class="btn btn-light btn-sm btn-labeled btn_click" style="border-color: #6a0f49;" title="Generar Reporte Excel" name="action" value="xlsx">

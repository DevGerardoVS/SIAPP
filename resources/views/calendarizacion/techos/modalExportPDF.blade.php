<div class="modal fade export-pdf" id="TechosExportPDF" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('TechosExportPDF')}}" method="get" id="formExportPDF">
                    @csrf
                    <div class="row">
                        <div class="col-sm-1">
                             <label><b>Año</b></label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="btnExportPDF">Exportar</button>
            </div>
        </div>
    </div>
</div>

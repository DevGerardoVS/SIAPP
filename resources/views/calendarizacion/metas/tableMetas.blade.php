<div class="modal-body" id='tableMetas'>
    <form id="createMeta">
            ...
            <table id="meses1" class="table table-hover table-striped ">
                ...
                <tbody>
                    <td><input onkeypress="return valideKey(event)" id="1" name="1" type="text"
                            class="form-control meses" onkeyup="dao.sumar('tableMetas');" disabled>
        ...
        <div class="table-responsive ">
            <table id="meses2" class="table table-hover table-striped" style="border-bottom-style: none;">
                ...
                <tbody>
                    <td><input onkeypress="return valideKey(event)" onkeyup="dao.sumar('tableMetas');" id="7"
                            name="7" type="text" class="form-control  meses" disabled>
                        <span id="7-error"></span>
                    </td>
                    <td><input onkeypress="return valideKey(event)" onkeyup="dao.sumar('tableMetas');" id="8"
                            name="8" type="text" class="form-control  meses" disabled>
                        <span id="8-error"></span>
                    </td>
                    <td><input onkeypress="return valideKey(event)" onkeyup="dao.sumar('tableMetas');" id="9"
                            name="9" type="text" class="form-control  meses" disabled>
                        <span id="9-error"></span>
                    </td>
                    <td><input onkeypress="return valideKey(event)" onkeyup="dao.sumar('tableMetas');" id="10"
                            name="10" type="text" class="form-control  meses" disabled>
                        <span id="10-error"></span>
                    </td>
                    <td><input onkeypress="return valideKey(event)" onkeyup="dao.sumar('tableMetas');" id="11"
                            name="11" type="text" class="form-control  meses" disabled>
                        <span id="11-error"></span>
                    </td>
                    <td><input onkeypress="return valideKey(event)" onkeyup="dao.sumar('tableMetas');" id="12"

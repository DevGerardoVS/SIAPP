...
<script type="text/javascript">
    ...
    function getDataFechaCorte(anio) { //función para actualizar el select fechas de corte
        return new Promise((resolve, reject) => { // Usar promises para que se llene primero el select y obtener su valor.
            $.ajax({
                ...
                success: function(data) { 
                    ...
                    var valorSeleccionado = par.val();
                    par.html('');
                    var getLastYear = {!! json_encode($anios[0]->ejercicio) !!}; // Variable para obtener el último año
                    ...
                    if(valorSeleccionado != null) par.val(valorSeleccionado);
                    resolve();
                },

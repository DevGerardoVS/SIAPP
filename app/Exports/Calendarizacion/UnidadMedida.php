...
class UnidadMedida implements FromCollection, ShouldAutoSize, WithHeadings, WithColumnWidths,WithTitle,WithStyles,WithEvents
{
    protected $filas;

    public function collection(){
        $data = MetasHelper::unidadMedida();
        $newData = [];
        foreach ($data as $key) {
             $a = array(
                 $key->id,
